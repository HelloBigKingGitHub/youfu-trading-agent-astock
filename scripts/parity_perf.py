...
written to STDERR:
    ...
    perf_ms: settings_FastAPI=Xms settings_React=Yms settings_Streamlit=Zms history_FastAPI=Xms history_React=Yms history_Streamlit=Zms logs_FastAPI=Xms logs_React=Yms logs_Streamlit=Zms chart_FastAPI=Xms chart_React=Yms chart_Streamlit=Zms sector_FastAPI=Xms sector_React=Yms sector_Streamlit=Zms batch_FastAPI=Xms batch_React=Yms batch_Streamlit=Zms portfolio_FastAPI=Xms portfolio_React=Yms portfolio_Streamlit=Zms schedule_FastAPI=Xms schedule_React=Yms schedule_Streamlit=Zms analyze_FastAPI=Xms analyze_React=Yms analyze_Streamlit=Zms
"""
...
PAGE_REGISTRY: dict[str, dict[str, str]] = {
    ...
    "analyze": {
        "FastAPI": "http://127.0.0.1:8000/api/analyze/recent?limit=10",
        "React": "http://localhost:5173/analyze",
        "Streamlit": "http://localhost:8501/analyze",
    },
}
